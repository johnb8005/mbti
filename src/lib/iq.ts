// https://www.quora.com/Whats-the-relationship-between-an-MBTI-and-IQ
// from (link does not work) http://psych.wisc.edu/henriques/papers/Sak.pdf
import * as T from "./type";

// type | N | gifted [%] | normative [%]
